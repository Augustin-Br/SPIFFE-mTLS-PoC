...
class AgentCommunicationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendPrompt = channel.unary_unary(
                '/agent.AgentCommunication/SendPrompt',
                request_serializer=agent__pb2.MessageRequest.SerializeToString,
                response_deserializer=agent__pb2.MessageReply.FromString,
...
def add_AgentCommunicationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendPrompt': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=agent__pb2.MessageReply.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'agent.AgentCommunication', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agent.AgentCommunication', rpc_method_handlers)
...
class AgentCommunication(object):
    ...
    def SendPrompt(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            agent__pb2.MessageReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
